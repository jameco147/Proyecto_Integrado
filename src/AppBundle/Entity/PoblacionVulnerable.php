...
class PoblacionVulnerable
{
     ...
     * @var bool
     *
     * @ORM\Column(name="exclusionSocial", type="boolean", nullable=true ,options={"default":"0"})
     */
     ...
     * @var bool
     *
     * @ORM\Column(name="mayores", type="boolean",   nullable=true, options={"default":"0"})
     */
    private $mayores;
     ...
     * @var bool
     *
     * @ORM\Column(name="mujeres", type="boolean",  nullable=true, options={"default":"0"})
     */
    private $mujeres;
     ...
     * @var bool
     *
     * @ORM\Column(name="ninyos", type="boolean",   nullable=true, options={"default":"0"})
     */
    private $ninyos;
     ...
     * @var bool
     *
     * @ORM\Column(name="jovenes", type="boolean",  nullable=true, options={"default":"0"})
     */
    private $jovenes;
     ...
     * @var bool
     *
     * @ORM\Column(name="migrantes", type="boolean",   nullable=true, options={"default":"0"})
     */
    private $migrantes;
     ...
     * @var bool
     *
     * @ORM\Column(name="otros", type="boolean",  nullable=true, options={"default":"0"})
     */
    private $otros;
